      ...
      <div class="modal-body">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 p-0 mb-3">
                   <label class="form-label">Confirm Paaword</label>
                   <input type="password" class="form-control shadow-none" >
                </div>
            </div>
        </div>
  ...
  <div class="swiper swiper-container" >
    <div class="swiper-wrapper"  >
      <div class="swiper-slide" >
        <img src="images/H9.png" class="w-100 d-block ">
      </div>
      <div class="swiper-slide">
        <img src="images/H5.png" class="w-100 d-block ">
      </div>
      <div class="swiper-slide">
        <img src="images/H15.png" class="w-100 d-block ">
      </div>
      <div class="swiper-slide">
        <img src="images/H16.png" class="w-100 d-block ">
      </div>
    </div>
  </div>
</div>
    ...
    <div class="col-lg-4 p-4">
      <h3 class=" fw-bold fs-3 mb-2">Treno SL</h3>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
         Cumque et aliquid suscipit totam, adipisci tenetur 
         quia itaque sint! Magnam deleniti enim amet ducimus nostrum 
         perspiciatis nobis consequatur minima consequuntur accusamus.
        </p>
    </div>
    <div class="col-lg-4 p-4">
